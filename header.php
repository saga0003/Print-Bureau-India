...
<header class="pbi-header">
  <div class="pbi-wrap pbi-header__inner">
    ...
    <?php if (has_nav_menu('primary')) { wp_nav_menu(['theme_location'=>'primary','container'=>'nav','container_class'=>'pbi-nav','menu_class'=>'pbi-nav','fallback_cb'=>false,'depth'=>2]); } else { pbi_primary_menu_fallback(); } ?>
  ...
  <div class="pbi-wrap" data-mobile-nav hidden>
    <nav style="display:grid;gap:2px;padding:10px 0 18px">
      ...
      <a href="<?php echo esc_url(get_permalink((int)get_option('page_for_posts')) ?: home_url('/blog/')); ?>">Resources</a>
